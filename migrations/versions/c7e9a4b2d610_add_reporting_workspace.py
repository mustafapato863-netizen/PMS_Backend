...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.CheckConstraint("output_format IN ('excel')", name="ck_generated_report_format"),
    ...
    op.create_table(
        ...
        sa.CheckConstraint("preferred_format IN ('excel')", name="ck_saved_report_template_format"),
