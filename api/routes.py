...
# Ensure the project root (parent of the api/ package) is on sys.path so that
# sibling packages such as exports, models, services, etc. are always importable
# regardless of how this module is loaded (e.g. directly by uvicorn or via app.py).
